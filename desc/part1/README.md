...
You should make sure that the resulting grammar is non-ambiguous, eliminate left recursion and ensure that the usual C precedence rules for operators are respected based on this table (higher precedence first):
